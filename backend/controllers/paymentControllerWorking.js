...
export const initiateEsewaPayment = async (req, res) => {
    ...
    try {
        ...
        console.log("Payment request:", { appointmentId, user: user?.id });
        ...
        // Find appointment and verify it's approved
        ...
        if (appointment.patientId._id.toString() !== user.id) {
...
export { esewaPaymentCallback, checkPaymentStatus };
