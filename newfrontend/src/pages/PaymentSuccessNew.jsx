// Payment Success Page - New Implementation
              ...
              <div className="space-y-3">
                ...
                {appointment.paymentDate && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{new Date(appointment.paymentDate).toLocaleDateString()}</span>
                  </div>
                )}
                {appointment.transactionCode && (
                  <div className="flex justify-between">
                    <span className="text-gray-600">Transaction Code:</span>
                    <span className="font-medium">{appointment.transactionCode}</span>
                  </div>
                )}
              </div>
            </div>
